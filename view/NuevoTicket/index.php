...
<html>
	...
	<title>DiegoVidal</>::Nuevo Ticket</title>
</head>
			...
			<div class="box-typical box-typical-padding">
				...
				<div class="row">
					<form method="post" id="ticket_form">
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								<label class="form-label semibold" for="exampleInput"><!-- Categoria -->Departamento</label>
						...
						<div class="col-lg-6">
							<fieldset class="form-group">
								<label class="form-label semibold" for="exampleInput"><!-- SubCategoria -->Tipo De Solicitud</label>
