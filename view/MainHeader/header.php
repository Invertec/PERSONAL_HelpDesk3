<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="#" class="site-logo">
            <img class="hidden-md-down" src="../../public/img/invertec.png" alt="">
            <img class="hidden-lg-up" src="../../public/img/invertec.png" alt="">
        </a>
        ...
        <div class="site-header-content">
            <div class="site-header-content-in">
                ...
                <input type="hidden" id="emp_idx" value="<?php echo $_SESSION["emp_id"] ?>"><!-- Rol del Usuario-->
